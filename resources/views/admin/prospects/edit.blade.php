...
<div class="container">
    ...
    <div class="card mt-3">
        <div class="card-body">
            <div class="d-flex">
                <h1>Izmeni klijenta <small class="text-muted">{{ $prospect->name }}</small></h1>
                <div class="ml-auto">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                          ...
                          <a class="dropdown-item text-danger" href="#" onclick="deleteProspect()">Obriši klijenta</a>
            ...
            <div class="card mt-3">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.prospects.update', $prospect->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <button class="btn btn-primary float-right">Izmeni</button>
                    </form>
                </div>
            ...
            <div class="card mt-3">
                <div class="card-body">
                    ...
                    @else
                        <div class="d-flex">
                            <div class="mx-auto">
                                <a href="{{ route('admin.prospects.contacts.create', $prospect->id) }}" class="btn btn-outline-primary">Dodaj kontakt podatke</a>
                            </div>
                        </div>
                    @endif
                </div>
