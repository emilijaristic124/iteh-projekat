        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-8">
                ...
                <ul class="list-style-none">
                    ...
                    <li><strong>Datum kreiranja:</strong> {{ $prospect->pretty_created }}</li>
                </ul>
            </div>
            <div class="col-sm-3 col-md-2">
                <div class="dropdown d-block">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                        <a href="{{ route('admin.prospects.prospect.dashboard', ['prospect' => $prospect->id]) }}" class="dropdown-item">Dashboard</a>
                        <a class="dropdown-item" href="{{ route('admin.prospects.edit', ['prospect' => $prospect->id]) }}">Izmeni</a>
                        <a class="dropdown-item" href="{{ route('admin.prospects.activities.dashboard', ['prospect' => $prospect->id]) }}">Pregled interakcija</a>
